...
var (
	...
	// Строгость включена по умолчанию с фазы 3: потеря и порча вывода закрыты,
	// и тест из измерителя стал сторожем. Флаг оставлен, чтобы можно было
	// снять замеры на заведомо сломанном дереве, не правя код.
