...
// TestConfigErrorHasPosition — находка C7: раньше ошибка разбора сообщала
// только имена команды и цепочки, без места в файле, и на конфигурации в
// полторы сотни строк искать приходилось глазами.
